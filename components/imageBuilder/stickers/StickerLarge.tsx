...
export const StickerLarge: React.FC = () => {
  ...
  const animatedProps = useAnimatedProps(() => ({
    strokeDashoffset: 495.98 - progress.value,
  }));
  ...
  useEffect(() => {
    ...
    progress.value = withTiming(ratio * 495.98, {
      duration: 2000,
    });
  ...
  return (
    <View>
      <EditWrapper borderSize={1} canRotate={false} canScale={false}>
